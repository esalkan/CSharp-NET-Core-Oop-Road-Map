namespace CS01_24_Operators_Modulus_Increment_Decrement
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			Console.WriteLine("After incremented postInc variable value came from memory and result is  : " + postInc + "\n");
			...
			Console.WriteLine("After decremented postDec variable value came from memory and result is  : " + postDec + "\n");
